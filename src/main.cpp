/*********************************
	Copyright: OroChippw&Fengkun lv
	Author: OroChippw&Fengkun lv
	Date: 2024.06.17
	Description:
*********************************/
#pragma once
...
int main(int argc, char* argv[])
{
	...
	bool end2end;
	std::string device; // Now support "cpu" / "cuda" = "${Device}"
	bool viz = true;
	...
	/* ****** Usage Example Start ****** */
	image_path1 = "D:\\lvfengkun\\data\\2024-6-7\\block\\left";
	image_path2 = "D:\\lvfengkun\\data\\2024-6-7\\block\\right";
	device = "cpu";//cuda

	// End to End 
	//end2end = true; 
	//lightglue_path = "D:\\lvfengkun\\circle_matching\\onnx-matching\\SIFT-LightGlue\\models\\superpoint_lightglue_end2end.onnx";
	//extractor_type = "SuperPoint";
	//lightglue_path = "D:\\lvfengkun\\circle_matching\\onnx-matching\\SIFT-LightGlue\\models\\disk_lightglue_end2end_fused_cpu.onnx";
	//extractor_type = "Disk";

	// Decouple
	end2end = false;
	extractor_path = "D:\\lvfengkun\\circle_matching\\onnx-matching\\SIFT-LightGlue\\models\\superpoint.onnx";
	lightglue_path = "D:\\lvfengkun\\circle_matching\\onnx-matching\\SIFT-LightGlue\\models\\superpoint_lightglue.onnx";
	extractor_type = "SuperPoint";
	//extractor_path = "D:\\lvfengkun\\circle_matching\\onnx-matching\\SIFT-LightGlue\\models\\disk.onnx";
	//lightglue_path = "D:\\lvfengkun\\circle_matching\\onnx-matching\\SIFT-LightGlue\\models\\disk_lightglue_fused_cpu.onnx";
	//extractor_type = "Disk";
